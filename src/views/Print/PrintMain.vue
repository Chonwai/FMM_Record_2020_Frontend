...
<div id="print-record-container" class="p-12">
    <h1 class="text-3xl font-bold mb-4">表單列印</h1>
    <main class="form-container">
        <FromHead />
        <div class="flex flex-wrap">
            <span class="w-1/2"></span>
            <FormElement class="w-1/2" title="表單編號：" subtitle="Form number:" :value="'FMM' + record.id" />
            <FormElement class="w-1/2" title="領取人：" subtitle="Name:" :value="record.taken_by" />
            <FormElement class="w-1/2" title="日期：" subtitle="Date:" :value="record.taken_at" />
            <FormElement class="w-1/2" title="職員/學生證號碼：" subtitle="Staff Number:" :value="record.staff_number" />
            <FormElement class="w-1/2" title="部門：" subtitle="Department:" :value="record.department" />
            <FormElement class="w-1/2" title="預期歸還：" subtitle="Date of Return:" :value="record.will_return_at" />
        ...
        <div class="flex flex-wrap">
            <FormElement class="w-1/2" title="交件人：" subtitle="Delivery Person:" :value="record.hired_out_by" />
            <FormElement class="w-1/2" title="收件人：" subtitle="Receiver:" :value="record.returned_by" />
            <FormElement class="w-1/2" title="日期：" subtitle="Date:" :value="record.hired_out_at" />
            <FormElement class="w-1/2" title="日期：" subtitle="Date:" :value="record.returned_at" />
        </div>
    </main>
</div>
</template>
